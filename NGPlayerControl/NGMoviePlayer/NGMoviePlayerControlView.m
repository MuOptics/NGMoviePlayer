...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        [_rewindControl setImage:[UIImage imageNamed:@"prevtrack"] forState:UIControlStateNormal];
        ...
        [_forwardControl setImage:[UIImage imageNamed:@"nexttrack"] forState:UIControlStateNormal];
...
- (void)updateButtonsWithPlaybackStatus:(BOOL)isPlaying {
    ...
    if (self.controlStyle == NGMoviePlayerControlStyleInline) {
        image = isPlaying ? [UIImage imageNamed:@"pause"] : [UIImage imageNamed:@"play"];
    } else {
        image = isPlaying ? [UIImage imageNamed:@"pauseFullscreen"] : [UIImage imageNamed:@"playFullscreen"];
    }
