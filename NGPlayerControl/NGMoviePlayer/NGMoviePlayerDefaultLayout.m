...
#warning Implementing full screen control will need to uncomment this, along with reimplementing PSPushPopPressView.h
    [self.zoomControl setHidden:YES];
    return 0;
...
- (void)setupScrubber:(NGScrubber *)scrubber controlStyle:(NGMoviePlayerControlStyle)controlStyle {
    ...
    if (controlStyle == NGMoviePlayerControlStyleFullscreen) {
        [scrubber setThumbImage:[UIImage imageNamed:@"scrubberKnobFullscreen"]
                       forState:UIControlStateNormal];
    } else {
        height = 10.f;

        [scrubber setThumbImage:[UIImage imageNamed:@"scrubberKnob"]
                       forState:UIControlStateNormal];
    }
...
- (UIImage *)bottomControlFullscreenImage {
    if (_bottomControlFullscreenImage == nil) {
        _bottomControlFullscreenImage = [UIImage imageNamed:@"fullscreen-hud"];
...
- (void)layoutSubviewsForControlStyleInline {
    ...
    [self.zoomControl setImage:[UIImage imageNamed:@"zoomIn"] forState:UIControlStateNormal];
...
- (void)layoutSubviewsForControlStyleFullscreen {
    ...
    UIImage *zoomButtonImage = [UIImage imageNamed:@"zoomOut"];
