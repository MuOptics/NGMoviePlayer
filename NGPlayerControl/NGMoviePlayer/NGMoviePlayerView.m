...
- (UIView *)externalScreenPlaceholder {
    if(_externalScreenPlaceholder == nil) {
        ...
        _externalScreenPlaceholder = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"playerBackground"]];
        ...
        UIImageView *externalScreenPlaceholderImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:(isIPad ? @"wildcatNoContentVideos@2x" : @"wildcatNoContentVideos")]];
