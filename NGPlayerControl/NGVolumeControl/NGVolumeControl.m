...
- (UIImage *)imageForVolume:(float)volume {
    ...
    if (volume < 0.001f) {
        return [UIImage imageNamed:@"Volume0"];
    } else if (volume < 0.33f) {
        return [UIImage imageNamed:@"Volume1"];
    } else if (volume < 0.66f) {
        return [UIImage imageNamed:@"Volume2"];
    } else {
        return [UIImage imageNamed:@"Volume3"];
    }
}
...
- (void)customizeSlider:(UISlider *)slider {
    ...
    [self.slider setThumbImage:[UIImage imageNamed:@"ScrubberKnob"] forState:UIControlStateNormal];
}
...
- (UIImage *)imageForSliderBackgroundForExpandDirection:(NGVolumeControlExpandDirection)expandDirection {
    UIImage *sliderBackgroundImage = [UIImage imageNamed:@"volume-background"];
